...
<div class="page-content" >
	<div class="card ccard mx-auto" style="width: 98%; position: sticky;">
		<div class="card-header pb-1 align-middle " style="
		border-top-right-radius: 0.4rem;border-bottom: 1px solid #e0e5e8 !important; border-top-left-radius: 0.4rem; border-top: 4px solid #004225;" >
