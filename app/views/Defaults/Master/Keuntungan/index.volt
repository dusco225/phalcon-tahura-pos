...
{% block title %}Master Tahura Margin Keuntungan
{% endblock %}
{% block content %}
<style>
	...
	<div class="card ccard mx-auto" style="width: 98%; position: sticky;">
		...
		border-top-right-radius: 0.4rem;border-bottom: 1px solid #e0e5e8 !important;" >
			<h4 class="card-title text-dark-m3 mt-2">
				Master - Tahura - Margin Kuntungan
			</h4>
						...
						<table id="datatable" class="table table-bordered border-0 w-100 table-striped-secondary text-dark-m1 mb-0">
							<thead>
								<tr class="bgc-info text-white text-center brc-black-tp10">
									...
									<th style="vertical-align: middle;">Margin</th>
								</tr>
							</thead>
							<tbody></tbody>
						</table>
			...
			<div class="modal-content radius-4">
				<div class="modal-header bgc-primary radius-t-4">
					<h4 class="modal-title text-white">
						<i class="fa fa-list text-white"></i>&nbsp;&nbsp; Form - Margin</h4>
							...
							<div class="col-sm-12" style="margin-bottom : 5px;">
								<div class="input-group">
									<div class="input-group-prepend">
										<span class="input-group-text" style="width: 150px;">Sebesar</span>
									</div>
									<input type="text" id="margin" name="margin" class="form-control" required>
								</div>
							</div>
						</div>
	...
	<div id="filterModal" class="modal fade" role="dialog">
		<div class="modal-dialog radius-4">
			...
			<div class="modal-content radius-4">
				<div class="modal-header bgc-primary radius-t-4">
					<h4 class="modal-title text-white">
						<i class="fa fa-search text-white"></i>&nbsp;&nbsp; Pencarian - Kategori</h4>
					<button type="button" class="close text-white" data-dismiss="modal">&times;</button>
				</div>
				<div class="modal-body">
...
{% block inline_script %}
<script>
	{% include 'Defaults/Master/Keuntungan/index.js' %}
</script>
{% endblock %}
